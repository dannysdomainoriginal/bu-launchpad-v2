...
CREATE TABLE "product_votes" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "product_votes_product_id_user_id_pk" PRIMARY KEY("product_id","user_id")
);
--> statement-breakpoint
...
CREATE INDEX "feedback_product_idx" ON "product_feedback" USING btree ("product_id");--> statement-breakpoint
CREATE INDEX "feedback_user_idx" ON "product_feedback" USING btree ("user_id");